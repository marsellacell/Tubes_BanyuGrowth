...
<head>
  ...
  <title>{{ $selectedCategory->nama_kategori }} | BanyuGrowth</title>
...
<body class="bg-white text-gray-800">
  ...
  <section class="mt-6 container mx-auto px-4">
    <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
      ...
      <span class="text-green-600 font-semibold">{{ $selectedCategory->nama_kategori }}</span>
    </div>

    <div class="flex items-center justify-between">
      <div>
        <h2 class="font-bold text-3xl text-gray-800">{{ $selectedCategory->nama_kategori }}</h2>
        <p class="text-gray-600 mt-2">Menampilkan {{ $produkList->count() }} produk dalam kategori ini</p>
      </div>
  ...
  <section class="mt-6 container mx-auto px-4">
    <div class="bg-white rounded-xl shadow-md p-4">
      <h3 class="font-semibold text-gray-700 mb-3 text-sm">Kategori Lainnya:</h3>
      <div class="flex flex-wrap gap-2">
        @foreach($categories as $category)
        <a href="{{ route('categories.show', $category->slug ?? $category->id) }}" class="px-4 py-2 rounded-full text-sm transition 
  ...
  <section class="mt-8 container mx-auto px-4 mb-10">
    ...
    <div class="text-center py-20">
      ...
      <p class="text-gray-500 mt-4 text-lg">Belum ada produk dalam kategori ini</p>
